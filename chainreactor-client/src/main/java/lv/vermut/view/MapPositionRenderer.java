...
public class MapPositionRenderer {
    ...
    private Map<Long, Marker> markerMap = new HashMap<>(); // Position.id -> Marker
    private Map<Long, Long> deviceMap = new HashMap<>(); // Device.id -> Position.id
    private Map<Long, Position> positionMap = new HashMap<>(); // Position.id -> Position
