...
public class ArchiveView implements SelectionChangedEvent.SelectionChangedHandler<Position> {
    ...
    public ArchiveView(ArchiveHandler archiveHandler, ListStore<Position> positionStore, ListStore<Device> deviceStore) {
        ...
        columnConfigList.add(new ColumnConfig<>(positionProperties.valid(), 0, "Valid"));

        ColumnConfig<Position, Date> columnConfigDate = new ColumnConfig<>(positionProperties.time(), 0, "Time");
        ...
        columnConfigList.add(new ColumnConfig<>(positionProperties.latitude(), 0, "Latitude"));
        columnConfigList.add(new ColumnConfig<>(positionProperties.longitude(), 0, "Longitude"));
        columnConfigList.add(new ColumnConfig<>(positionProperties.altitude(), 0, "Altitude"));

        ColumnConfig<Position, Double> columnConfigDouble = new ColumnConfig<>(positionProperties.speed(), 0, "Speed");
        ...
        columnConfigList.add(new ColumnConfig<>(positionProperties.course(), 0, "Course"));
        columnConfigList.add(new ColumnConfig<>(positionProperties.power(), 0, "Power"));
